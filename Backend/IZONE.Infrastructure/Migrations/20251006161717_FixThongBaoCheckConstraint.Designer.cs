...
namespace IZONE.Infrastructure.Migrations
{
    ...
    [Migration("20251006161717_FixThongBaoCheckConstraint")]
    partial class FixThongBaoCheckConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IZONE.Core.Models.ChiPhi", b =>
                {
                    ...
                    b.Property<string>("SubLoai")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("SubLoai");

                    b.Property<string>("ThoiGianKy")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("ThoiGianKy");
