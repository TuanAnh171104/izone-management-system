...
const StudentNotifications: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // Get user info to get hocVienID
      ...
      const hocVienID = user.hocVienID;
      ...
      console.log('🔄 Đang lấy thông báo cho học viên:', hocVienID);

      // Get notifications by recipient ID (this will include both personal and class notifications)
      const response = await thongBaoService.getByNguoiNhan(hocVienID);
